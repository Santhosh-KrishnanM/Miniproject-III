...
travelCards.forEach(card => {
  card.addEventListener('click', () => {
    ...
    perDayCost = currentVehicle.cost;

    popupImage.src = currentVehicle.image;
    popupName.textContent = `Name: ${currentVehicle.name}`;
    popupSeats.textContent = `Seats: ${currentVehicle.seats}`;
    popupCost.textContent = `Per Day Cost: ₹${currentVehicle.cost}`;
...
function calculateTotal() {
  ...
  if (start && end && end >= start) {
    ...
    const total = diffDays * perDayCost;
...
// ---------------------- BOOK TRAVELS BUTTON ---------------------- //
const bookTravelBtn = document.getElementById('bookTravelBtn');
if (bookTravelBtn) {
  bookTravelBtn.addEventListener('click', () => {
